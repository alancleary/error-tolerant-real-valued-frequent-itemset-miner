This project is a validation study of the work done in <cite>[1][1]</cite>.
...
The implementation is composed of two parts: 1) an implementation of Approximate Frequent Itemsets (AFI) <cite>[2][2]</cite> and 2) an extension of AFI to work with real-valued data via the *range* and *RangeSupport* measures from Range Support Pattern (RAP) <cite>[3][3]</cite>.

The first implementation will be tested on data generated by the IBM Quest Synthetic Data Set Generator <cite>[4][4]</cite>.
...
All these data sets will be aquired from the Gene Ontology Consortium <cite>[5][5]</cite>.
